...
| [Grid](gridview) | Issues               | [Experiments](experiments)     | [TALO](talo)                   |

### Flutter Issue Reports

The code samples below are from Flutter issues I have reported in the main Flutter 
...
useful and interesting code snippets, so I decided to record them and keep them available this was as well.
...
The above demos were made for the issue report [#63740](https://github.com/flutter/flutter/issues/63740). The source
code for the issue demo is available in this [Gist](https://gist.github.com/rydmike/2e8e6a4cc9126dbe6f95e81e674f6d6b).
...
use **very** simplified versions of code use in the Flexfold package. The samples are also useful as starting
points for various Flutter demos with just one file and no other than Flutter SDK dependencies.

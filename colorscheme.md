...
1. It allows you to toggle the dark theme between using the predefined hand-tuned dark colors, or calculating 
...
2. It can use the `ColorScheme` data that it is defined, and instead of creating the theme with its own `toTheme` 

...
*(Oct 24, 2022, Updated Nov 2, 2022)*

This article presents a Flutter application example that shows how to use [**FlexColorScheme**](https://pub.dev/packages/flex_color_scheme) together with [**Riverpod**](https://pub.dev/packages/flutter_riverpod) to dynamically change your persisted application theme. [[**Read more...**]](blog_theme_demo)

[<img src="https://github.com/rydmike/theme_demo/blob/master/resources/Screen05-Drawer.png?raw=true" alt="Theme demo" width="200"/>](blog_theme_demo)
...
In this article, I discuss challenges with the web center constrained layout in Flutter and provide a deeper dive and an example of how to theme Flutter applications. [[**Read more...**]](blog_layout_and_theming)
